...
class Min_Heap:
    ...
    def reheap_up(self):
        ...
        while True:
            ...
            #print(self.heap)
            if self.heap[child_index][1] + self.heuristics[self.heap[child_index][0]] > self.heap[parent_index][1] + self.heuristics[self.heap[child_index][0]] :
                #swap them
    ...
    def reheap_down(self):
        ...
        while True:
            ...
            print(self.heap)
            #time.sleep(1)
            if (self.heap[left_child_index][1] + self.heuristics[self.heap[left_child_index][0]])  > (self.heap[right_child_index][1] + self.heuristics[self.heap[right_child_index][0]]) and (self.heap[parent_index][1]  + self.heuristics[self.heap[parent_index][0]]) > (self.heap[right_child_index][1] + self.heuristics[self.heap[right_child_index][0]]):
                #swap parent with right child
                min_child_index = right_child_index

            if (self.heap[left_child_index][1]+ self.heuristics[self.heap[left_child_index][0]]) < (self.heap[right_child_index][1]+ self.heuristics[self.heap[right_child_index][0]]) and (self.heap[left_child_index][1]+ self.heuristics[self.heap[left_child_index][0]]) < (self.heap[parent_index][1]+ self.heuristics[self.heap[parent_index][0]]):
